...
#Evidentemente, para formar palavras é necessário que exista um alfabeto como, por exemplo, nosso alfabeto latino.
...
#Harry escreve na primeira linha e primeira coluna de uma folha quadriculada o primeiro caractere do alfabeto.
...
#Harry percebeu que dessa forma consegue formar um triângulo alfabético, semelhante ao visto na Figura 1,
#onde a primeira linha contém apenas um 'A' e a sétima contém sete 'G'.
#Como Harry precisa estudar para realizar uma prova de programação (que para ele também é uma forma de magia!),
#pediu sua ajuda para automatizar os desenhos dos "triângulos alfabéticos", criando um programa que receba como
#entrada um número inteiro N (1 <= N <= 26) e que desenhe um triângulo com exatas N linhas,
#seguindo a mesma estratégia descrita no texto. Note que o maior triângulo possível é aquele formado por vinte e seis linhas,
